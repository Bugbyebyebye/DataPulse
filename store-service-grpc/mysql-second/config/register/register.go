...
import (
	mysqlGrpc "commons/api/bottom/mysql-second/gen"
	"commons/config"
	"commons/config/etcd"
	"google.golang.org/grpc"
	"google.golang.org/grpc/resolver"
	"log"
	mysqlService "mysql-second/service"
	"net"
)
...
func GrpcRegister() {
	c := gRpcConfig{
		...
		RegisterFunc: func(g *grpc.Server) {
			mysqlGrpc.RegisterMysqlSecondServiceServer(g, &mysqlService.MysqlSecondService{})
		},
	}
