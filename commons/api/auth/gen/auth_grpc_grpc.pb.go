...
type TokenServiceClient interface {
	VerifyToken(ctx context.Context, in *Req, opts ...grpc.CallOption) (*Res, error)
}
...
func (c *tokenServiceClient) VerifyToken(ctx context.Context, in *Req, opts ...grpc.CallOption) (*Res, error) {
	out := new(Res)
...
type TokenServiceServer interface {
	VerifyToken(context.Context, *Req) (*Res, error)
...
func (UnimplementedTokenServiceServer) VerifyToken(context.Context, *Req) (*Res, error) {
...
func _TokenService_VerifyToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TokenServiceServer).VerifyToken(ctx, req.(*Req))
	}
